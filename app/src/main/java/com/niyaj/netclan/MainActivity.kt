...
import com.niyaj.designsystem.theme.AppTheme
import com.niyaj.model.DarkThemeConfig
import com.niyaj.model.ThemeBrand
import com.niyaj.netclan.ui.NetclanApp
...
private fun shouldUseAndroidTheme(
    ...
    is MainActivityUiState.Success -> when (uiState.appConfig.themeBrand) {
...
private fun shouldDisableDynamicTheming(
    ...
    MainActivityUiState.Loading -> false
    is MainActivityUiState.Success -> !uiState.appConfig.useDynamicColor
}
...
private fun shouldUseDarkTheme(
    ...
    is MainActivityUiState.Success -> when (uiState.appConfig.darkThemeConfig) {
